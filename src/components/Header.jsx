  ...
  return (
    <div className="header flex justify-between items-center fixed top-0 left-0 right-0 h-16  px-2 lg:px-10 shadow-md z-40 bg-white ">
        ...
        >
          ...
          <span className={`${carts.length === 0 && 'hidden'} absolute text-md h-7 w-7 text-center top-0 shadow-2xl bottom-5 rounded-4xl text-white bg-accent`}>{carts.length}</span>
        </div>
